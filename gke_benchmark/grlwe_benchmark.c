...
int main() {
	...
	TIME_OPERATION(calculate_augmented_pubkey(0, 3, s,  &ctx), "calculate_augmented_pub_key0", ITERATIONS / 50)
	TIME_OPERATION(calculate_augmented_pubkey(1, 3, s, &ctx), "calculate_augmented_pub_key1", ITERATIONS / 50)
	TIME_OPERATION(calculate_augmented_pubkey(2, 3, s, &ctx), "calculate_augmented_pub_key2", ITERATIONS / 50)

	TIME_OPERATION(calculate_reconcile(3, s, c, k, hk, &ctx), "calculate_reconcile", ITERATIONS / 50)
	TIME_OPERATION(calculate_session_key(0, 3, s, c, k, hk, &ctx), "calculate_session_key", ITERATIONS / 50)
